 ...
 */
public class TwitterFireHoseToPulsarCopier extends SimpleCopier<String, byte[]> {

    public TwitterFireHoseToPulsarCopier() {
        super(new TwitterFireHose(), new PulsarSink(), x -> x.getBytes());
    }

    public static void main(String[] args) throws Exception {
        TwitterFireHoseToPulsarCopier instance = new TwitterFireHoseToPulsarCopier();
